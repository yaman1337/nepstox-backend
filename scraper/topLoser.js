...
export default async function getTopLoser(url) {
  try {
    ...
    console.log(error);
    throw new Error("Error fetching top loser.")
  }
}

export async function getNewTopLoser() {
  try {

    let url = "https://merolagani.com/MarketSummary.aspx?type=losers";
    ...
    console.log(error);
    throw new Error("Error fetching top losers.")
  }
}